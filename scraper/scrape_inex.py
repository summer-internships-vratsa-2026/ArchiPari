...
PRODUCTS = {
    "lepilo-plochki-ceresit-cm11-25kg": {
        # ЗАБЕЛЕЖКА: страницата показва наличност само в конкретен обект
        # (Строймаркет Инекс, Враца) — провери дали продуктът реално се
        # доставя в цялата страна, преди да разчиташ на тази оферта.
        "url": f"{BASE_URL}/p/promo-tserezit-sm-11-lepilo-za-plochki-25-kg-48br-sm14467",
