...
PRODUCTS = {
    ...
    "mazilka-silikonova-b2-vlachena-25kg": {  # <- същото id във всички скрапери за този продукт!
        # ЗАБЕЛЕЖКА: Bauhaus продава опаковка 25+2.5 кг гратис (общо 27.5 кг)
        # на промо цена 51.95 € за кофата — по-голяма разфасовка от
        # стандартните 25 кг при другите магазини. Цената по-долу е за
        # кофата като цяло (базовата продавана единица), не преизчислена
        # за 25 кг — виж matchNote в data/products.json.
        "url": f"{BASE_URL}/silikonova-mazilka-deko-professional-b2-dpr/p/159737",
